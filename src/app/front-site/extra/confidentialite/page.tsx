        ...
        <Section paddingY="large">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="legal-content">
              ...
              {/* Données collectées */}
              <div className="legal-section">
                <h2 className="legal-section-title">1. Données personnelles collectées</h2>
                <p className="legal-text">
              ...
              {/* Finalités */}
              <div className="legal-section">
                <h2 className="legal-section-title">2. Finalités du traitement</h2>
                <p className="legal-text">
              ...
              {/* Base légale */}
              <div className="legal-section">
                <h2 className="legal-section-title">3. Base légale du traitement</h2>
                <p className="legal-text">
              ...
              <div className="legal-section">
                <h2 className="legal-section-title">4. Durée de conservation des données</h2>
                <p className="legal-text">
              ...
              {/* Partage des données */}
              <div className="legal-section">
                <h2 className="legal-section-title">5. Partage des données</h2>
                <p className="legal-text">
              ...
              {/* Sécurité */}
              <div className="legal-section">
                <h2 className="legal-section-title">7. Sécurité des données</h2>
                <p className="legal-text">
              ...
              {/* Cookies */}
              <div className="legal-section">
                <h2 className="legal-section-title">8. Cookies et technologies similaires</h2>
                <p className="legal-text">
              ...
              <div className="legal-section">
                <h2 className="legal-section-title">9. Transferts internationaux</h2>
                <p className="legal-text">
              ...
              {/* Mineurs */}
              <div className="legal-section">
                <h2 className="legal-section-title">10. Protection des mineurs</h2>
                <p className="legal-text">
              ...
              {/* Contact */}
              <div className="legal-section">
                <h2 className="legal-section-title">11. Contact et réclamations</h2>
                <p className="legal-text">
                ...
                <p className="legal-text">
                  ...
                  (Commission Nationale de l&apos;Informatique et des Libertés) : <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="legal-link">www.cnil.fr</a>
                </p>
              </div>

              {/* Modifications */}
              <div className="legal-section">
                <h2 className="legal-section-title">12. Modifications de la politique</h2>
                <p className="legal-text">
