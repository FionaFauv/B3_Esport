          ...
          <Container>
            <div className="max-w-4xl mx-auto">
              ...
              <div className="meru-legal-section">
                <h2 className="meru-legal-section-title">1. Éditeur du site</h2>
              ...
              <div className="meru-legal-section">
                <h2 className="meru-legal-section-title">2. Directeur de la publication</h2>
                <p className="meru-legal-text">
              ...
              {/* Hébergement */}
              <div className="meru-legal-section">
                <h2 className="meru-legal-section-title">3. Hébergement</h2>
                <p className="meru-legal-text">
                ...
                <ul className="meru-legal-list">
                  ...
                  <li><strong>Site web :</strong> <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="meru-legal-link">vercel.com</a></li>
                </ul>
              </div>

              {/* Propriété intellectuelle */}
              <div className="meru-legal-section">
                <h2 className="meru-legal-section-title">4. Propriété intellectuelle</h2>
                <p className="meru-legal-text">
              ...
              <div className="meru-legal-section">
                <h2 className="meru-legal-section-title">5. Protection des données personnelles</h2>
                <p className="meru-legal-text">
                ...
                <p className="meru-legal-text">
                  Pour plus d&apos;informations, consultez notre <a href="/front-site/extra/confidentialite" className="meru-legal-link">Politique de Confidentialité</a>.
                </p>
              </div>

              {/* Cookies */}
              <div className="meru-legal-section">
                <h2 className="meru-legal-section-title">6. Cookies</h2>
                <p className="meru-legal-text">
              ...
              {/* Responsabilité */}
              <div className="meru-legal-section">
                <h2 className="meru-legal-section-title">7. Limitation de responsabilité</h2>
                <p className="meru-legal-text">
              ...
              {/* Droit applicable */}
              <div className="meru-legal-section">
                <h2 className="meru-legal-section-title">8. Droit applicable et juridiction</h2>
                <p className="meru-legal-text">
